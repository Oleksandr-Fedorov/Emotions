...
export const LevelThree: React.FC<LevelProps & { onHealthChange: (n: number) => void }> = ({ videoRef, onNextLevel, onHealthChange }) => {
  // --- STATE ---
  ...
  return (
    <div className="level-container">
      ...
      <aside className="sidebar">
        <h2>Уровень 3</h2>
        <div className="score-badge" style={{ marginTop: '10px', fontSize: '1.2rem', color: '#646cff' }}>
          Счет: <b>{score}</b>
        </div>
        ...
        <div style={{ marginTop: '20px' }}>
          ...
          <div style={{ 
            ...
            Повтори: {EMOJI_MAP[targetEmotion]}
          </div>
            ...
            <div className="intro-overlay">
              <div className="intro-content">
                ...
                <p className="intro-text">
                  <b>Бесконечный режим</b><br/>
                  Успей повторить эмоцию, пока не вышло время!
                </p>
            ...
            <div className="dialogue-section">
              ...
              <div className="chat-bubble">
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                  <h3>
                    {roundResult === 'success' ? "Отлично! +1 очко" : 
                     roundResult === 'fail' ? "Упс! Время вышло" : 
                     <>Покажи {EMOJI_MAP[targetEmotion]} ({targetEmotion})</>}
                  </h3>
                  
                  {roundResult === null && (
                    <p style={{ opacity: 0.6, fontSize: '0.9em', margin: 0 }}>
                      Осталось: <b>{timeLeft.toFixed(1)}с</b>
                    </p>
                  )}
                </div>
              </div>
